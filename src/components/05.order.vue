                    ...
                    <div class="cart-box">
                        ...
                        <div id="orderForm" name="orderForm" url="">
                            <div class="form-box address-info">
                                <dl class="form-group">
                                    ...
                                    <dd>
                                        ...
                                        <input name="accept_name" id="accept_name" type="text" class="input" value=""
                                            datatype="s2-20" sucmsg=" ">
                                ...
                                <dl class="form-group">
                                    <dt>详细地址：</dt>
                                    <dd>
                                        <input name="address" id="address" type="text" class="input" value="" datatype="*2-100"
                                            sucmsg=" ">
                                ...
                                <dl class="form-group">
                                    <dt>手机号码：</dt>
                                    <dd>
                                        <input name="mobile" id="mobile" type="text" class="input" value="" datatype="m"
                                            sucmsg=" ">
                            ...
                            <ul class="item-box clearfix">
                                ...
                                <li>
                                    <label>
                                        <input name="express_id" type="radio" onclick="freightAmountTotal(this);" value="1"
                                            datatype="*" sucmsg=" ">
